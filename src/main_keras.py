...
DATA = r'C:\Users\ngocq\Desktop\Project\rhinitisprediction-master\dataset\experiment2(vt_ob_bo_me)\data_train2.csv'
CHECK = '.\model'
CHECKh5='.\modelh52'
PLOT = 'yes'
...
def create_model(dataset_size):

	model = Sequential()
	model.add(Dense(dataset_size, input_dim=dataset_size, kernel_initializer='normal', activation='relu'))
...
def main(args):
	...
	history = model.fit(X_train, Y_train, validation_data=(X_test, Y_test), epochs=400, batch_size=20, verbose=1)
